...
const LandingPage = () => {
  ...
  return (
    <div className="mt-5">
      <h1 style={{ padding: "0px 30px 10px 30px" }}>
        Welcome to an assortment of TWD CRUD apps!
      </h1>
      <div
        className={
          mode === "dark"
            ? "contentDark landingPage mb-3"
            : "content landingPage mb-3"
        }
      >
        <h3>What is CRUD?</h3>
        <h5>CRUD stands for create, read, upate, delete. </h5>
        <h6>
          Users will be able to create, read, update and delete objects from a
          database.
        </h6>
        <p>
          <strong>Built with:</strong> Mongoose, Express, React, Node, RESTful
          API, Bootstrap, React-Router, Axios, Socket.IO, Multer
        </p>
        <p>
          <strong>Universal features:</strong> Registration, login, and
          protected routes with JWT/BCrypt/Cookie authentication. Real-time
          CRUD. Many to many relationships. Dark mode. Profile pictures.
        </p>
      </div>
      <div className=" flex mx-auto">
        <div className="row mx-auto" style={{ gap: "12px" }}>
          <div
            className={mode === "dark" ? "contentDark mb-3" : "content mb-3"}
          >
            <Link to={"/bookClub"}>
              <h3>Book Club</h3>
            </Link>
            <p>
              <strong>Unique features:</strong> column sorting, pagination
            </p>
          </div>
          <div
            className={mode === "dark" ? "contentDark mb-3" : "content mb-3"}
          >
            ...
            <p>
              <strong>Unique features:</strong> auto-sort, pagination, search
            </p>
          </div>
          <div
            className={mode === "dark" ? "contentDark mb-3" : "content mb-3"}
          ...
          {/* <div className={ mode === "dark" ? "contentDark mb-3" : "content mb-3"}>
